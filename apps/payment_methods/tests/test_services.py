...
class MPServiceTests(TestCase):
    ...
    def test_create_order_no_shipping_info_reject(self):
        """
        Tests if service can't create an order with pay data without shipping info
        """
        # Create product
        category = Category.objects.create(title="TestCategory")
    ...
    def test_create_order_invalid_data_reject(self):
        """
        Tests if service can create an order with pay data
        """
        # Create product
